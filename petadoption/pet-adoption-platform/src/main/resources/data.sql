...
INSERT INTO pet (id, name, age, gender, color, description, pet_type_id, pet_breed_id, fee) VALUES
(1, 'Max', 3, 'Male', 'Black and Tan', 'Friendly and protective', 1, 1, 300),
(2, 'Bella', 2, 'Female', 'Sable', 'Loyal and smart', 1, 1, 350),
(3, 'Rex', 4, 'Male', 'Black', 'Strong and brave', 1, 1, 320),
(4, 'Lucy', 5, 'Female', 'Black and Mahogany', 'Gentle and calm', 1, 2, 400),
(5, 'Rocky', 3, 'Male', 'Black and Tan', 'Energetic and fearless', 1, 2, 380),
(6, 'Zoe', 4, 'Female', 'Black and Rust', 'Loving and playful', 1, 2, 370),
(7, 'Daisy', 2, 'Female', 'White and Gold', 'Cheerful and affectionate', 1, 3, 250),
(8, 'Buddy', 3, 'Male', 'Black and White', 'Friendly and playful', 1, 3, 260),
(9, 'Lola', 1, 'Female', 'Brown and White', 'Sweet and calm', 1, 3, 240);

-- Inserting sample pets (Cats)
INSERT INTO pet (id, name, age, gender, color, description, pet_type_id, pet_breed_id, fee) VALUES
(10, 'Whiskers', 4, 'Female', 'White', 'Gentle and affectionate', 2, 4, 500),
(11, 'Shadow', 3, 'Male', 'Blue', 'Quiet and calm', 2, 4, 520),
(12, 'Mittens', 2, 'Female', 'Cream', 'Playful and curious', 2, 4, 510),
(13, 'Simba', 3, 'Male', 'Seal Point', 'Loyal and loving', 2, 5, 600),
(14, 'Nala', 2, 'Female', 'Blue Point', 'Graceful and elegant', 2, 5, 620),
(15, 'Leo', 4, 'Male', 'Chocolate Point', 'Smart and curious', 2, 5, 610),
(16, 'Cleo', 3, 'Female', 'Brown Tabby', 'Playful and sociable', 2, 6, 700),
(17, 'Oscar', 4, 'Male', 'Blue Tabby', 'Calm and friendly', 2, 6, 720),
(18, 'Luna', 2, 'Female', 'Red Tabby', 'Curious and adventurous', 2, 6, 710);
